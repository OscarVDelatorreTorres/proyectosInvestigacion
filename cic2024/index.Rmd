---
title: Algoritmos de inteligencia artificial bayesiana para la cobertura de los precios aguacate Hass, limón, zarzamora y maíz producidos en el Estado de Michoacán por medio coberturas agrícolas de las Bolsas de mercancías de Chicago y Nueva York provistas por SEGALMEX
author: |
...
**Aprobación CIC-UMSNH:** [Liga de la aprobación](https://cic.umich.mx/proyectos-de-investigacion/cic/72-2024/proyectos-aprobados-2024.html)

**Modalidad:** Proyectos de investigación financiados por la Coordinación de la Investigación Científica de la IUMSNH en **modalidad de 2 años** susceptble a extenderse a 3 años.

# (abstract) Resumen ejecutivo del proyecto

En el presente proyecto de investigación se propone el desarrollo de un algoritmo de inteligencia artificial de una cobertura sintética para cubrir el precio de compra (venta) del precio nacional del aguacate, el limón, la zarzamora y el maíz producidos en el Estado de Michoacán.
Para desarrollar dicha cobertura sintética se propone replicar el esquema de precios de garantía de SEGALMEX en las que este organismo del Gobierno Federal adquiere coberturas del maíz, trigo y arroz en las bolsas de derivados de Chicago y Nueva York. Esto a fin de ofrecer una cobertura (precios de garantía) de estas 4 mercancías a los productores michoacanos. Partiendo de esta necesidad práctica (cobertura del precio del aguacate, limón, zarzamora y maíz), se propone en este proyecto de investigación el desarrollo y prueba de un algoritmo de inteligencia artificial bayesiana que permita diseñar y seleccionar un portafolio óptimo de opciones de los principales futuros agrícolas de las bolsas de derivados de Chicago y Nueva York. 
El objetivo fundamental del presente proyecto es demostrar la viabilidad material y factibilidad de los algoritmos para lograr las coberturas sintéticas que podría diseñar SEGALMEX para ofrecer un precio de garantía del precio nacional del aguacate, el limón, la zarzamora y el maíz producidos en Michoacán.
...
SEGALMEX puede ofrecer coberturas de precio y cosecha a pequeños y medianos productores de arroz, frijol, leche, maíz y trigo. Para lograr esto, el organismo se vale de la adquisición de coberturas del precio internacional de estas mercancías en las Bolsas de Derivados de Chicago (CBOT) y Nueva York (NYMEX). En específico adquiere opciones que le permitan trasladar el riesgo del precio pactado al emisor de dichas coberturas, a efecto de cubrir el diferencial del precio pactado y el de mercado.
...
Dado que el aguacate, limón, zarzamora y maíz producido en Michoacán no son mercancías o *commoditties* con amplia negociación y liquidez como son el maíz, el trigo o el arroz, no existe interés ni necesidad en el CBOT o del NYMEX de emitir coberturas (futuros u opciones) relacionadas al aguacate Hass u otras variedades. Para poder solventar esta necesidad se pueden realizar **coberturas sintéticas**. Este tipo de coberturas se logra mediante un portafolio de futuros u opciones cuyo comportamiento en su valor replique el valor o mercancía (aguacate, limón, zarzamora o maíz michoacanos). 
...
Por cuestiones de espacio en el formulario del SIIA web de la UMSNH se resumieron las metas dle proyecto en 2 de estas. Lo anterior se hizo con l finalidad de aprovechar el limitado espacio en las metas.

## Metas presentadas en formulario del SIIA web de la UMSNH

1) Simular y demostrar que el utilizar coberturas sintéticas (portafolios de opciones de mercancías agrícolas de las bolsas de Nueva York y Chicago) permite generar una mayor productividad o beneficios a los productores o comercializadores de aguacate, limón, zarzamora y maíz de Michoacán. 
2)Desarrollar bases de datos (actualizables de manera automática) y aplicaciones en línea para que, tanto los resultados de las simulaciones como los algoritmos de toma de decisiones de estos 4 productos agrícolas, para que puedan estar disponibles de forma gratuita para productores, comercializadores y SEGALMEX
3) Publicar resultados en revistas científicas y congresos académicos.

## Metas expuestas a detalle para la mesa revisora de la CIC-UMSNH (metas oficiales)
...
Para lograr las metas planteadas en los apartados de objetivos, Metas y entregables en el proyecto de investigación, se cuenta con infraestructura tecnológica suficiente, la cual se ha adquirido con proyectos de investigación previos como son los de Apoyo a nuevo PTC de PRODEP-SEP o los propios proyectos de investigación financiados, por parte de la Coordinación de la Investigación Científica (CIC) de la Universidad Michoacana de San Nicolás de Hidalgo (UMSNH), desde el año 2016, al sustentante de este proyecto. La infraestructura con que actualmente se cuenta es la siguiente:
...
3. Lenguajes de programación R y Python ejecutados tanto en Rstudio como en Jupiter Networks. Esto para programar y ejecutar los CRONES que, de manera automática, actualizan las simulaciones realizadas.
4. Una licencia de Shiny apps para la publicación de las aplicaciones interactivas en línea con los resultados de las simulaciones previas. Esta se paga actualmente con recursos propios del Dr. Oscar V. De la Torre Torres (la CIC de la UMSNH actualmente no le pueden apoyar con este rubro) y se pretende financiar las mismas con recursos de un potencial proyecto concurrente financiado por ICTI en 2024 (propuesta de investigación en proceso de evaluación por ICTI).
5. Una licencia de las bases de datos económicos, financieras y de futuros Refinitiv Eikon y Economatica que actualmente paga el Dr. Oscar V. De la Torre Torres con recursos propios (la CIC de la UMSNH actualmente no le puede apoyar con este rubro).

Esta infraestructura permitirá la ejecución de las simulaciones, así como la estimación de los algoritmos de inteligencia artificial que permitirán diseñar y proponer la cobertura sintética de los precios de los 4 productos agrícolas de interés (aguacate, limón, zarzamora y maíz).

Para consultar la infraestructura a detalle y el diagrama de la arquitectura informática que se tiene, favor de consultar www.oscardelatorretorres.com/cic2024

**NOTA**: se espera este proyecto tenga concurrencia con un proyecto de ICTI en el PCIR 2023 (propuesta en proceso de evaluación).
...
# Presupuesto o planeación financieroa del proyecto{#Desglose}

En el Cuadro 1 siguiente se detallan los rubros a financiar para la ejecución del proyecto de investigación. Como se puede apreciar, se solicita un monto total de \$ 79,000.00 por los 2 años (\$39,500.00 para el año 2024 y \$39,500 para el año 2025).
...
ft=flextable(prespuesto1)%>%autofit%>%bold(i=c(8),j = c("rubro", "Monto2024","Monto2025","TotalRubro","porcentaje"), bold = TRUE)%>% 
  hline(i = 7,j= c("rubro", "Monto2024","Monto2025","TotalRubro","porcentaje"))%>%
  vline(j= 1)%>% 
  vline(j= 2)%>% 
  vline(j= 3)%>%
  vline(j= 4) 
ft=set_header_labels(ft,
                  ...
                  Monto2024="Monto solicitado para 2024",
                  Monto2025="Monto solicitado para 2025",
                  TotalRubro="Total por rubro en el proyecto (2 años)",
...
En el Cuadro 1 se aprecia el presupuesto por rubro a financiar, partiendo del concepto por objeto de gasto. La justificación de cada rubro, en virtud de las actividades a realizar se detalla a continuación.

### Materiales de oficina

Este rubro representa un 2.53\% del total y comprende la adquisición de papel y tóner para impresión, así como artículos de papelería que se necesiten.

### Equipos menores de tecnologías de la información y comunicaciones

Este rubro representan un 1.27\% del total y considera posibles adquisiciones de memorias USB y discos de respaldo para las simulaciones e información del proyecto.

### Material para información en actividades de investigación científica y tecnológica

Este rubo es el más importante y tiene una participación del 27.85\% en el total. Contempla la adquisición de libros especializados y relacionados a la temática del proyecto de investigación. También considera la contratación de suscripciones a revistas o adquisición de artículos en revistas científicas que no han sido adquiridas por medio de CONRICyT o la dirección general de bibliotecas de la UMSNH.

### Servicio postal

Este rubro representa 1.27\% del total y considera los gastos de envío de libros especializados que se compren por medio de proveedores extranjeros. Muchos de los libros de especialidad son extranjeros y no se distribuyen en librerías mexicanas. Es por ello que se considera este rubro como parte del proyecto.

### Instalación, reparación y mantenimiento de equipo de cómputo y tecnología de información

Parte de la infraestructura informática con la que se integra la arquitectura para las simulaciones y pruebas requiere mantenimiento. De ahí que se considere este rubro. Este rubro tiene un peso de 7.59\%

### Viáticos nacionales para personal en el desempeño de funciones oficiales

Se tiene considerado asistir a congresos de investigación. Derivado de esto, es que se requiere de contar con viáticos para poder asistir a estos eventos que se atiendan de manera presencial. Este rubro representa 29.11\% del total.

### Eventos académicos

Se tiene, dentro de los entregables comprometidos, la presentación de ponencias en al menos 2 congresos. estos tiene cuotas de inscripción que se consideran como aprte del presupuesto en este rubro. El mismo tiene un peso de 30.38\%
...
gantt1=ggplot() +
  ...
  labs(title="Figura 2. Planeación tentativa del proyecto de investigación.",
       x = "Tarea",
       y = "Fecha",
       colour = "Actividad")+theme(legend.position="right")
